  ...
  return (
    <section className="overflow-hidden bg-(image:--hero-gradient)">
      <div className="mx-auto w-full max-w-[1720px] px-6 sm:px-8 md:px-12 xl:px-[76px]">
        <div className="relative min-h-[calc(100svh-57px)] pb-[52vw] pt-9 sm:pb-[43vw] sm:pt-10 md:pb-[34vw] md:pt-12 xl:min-h-[calc(100vh-81px)] xl:pb-0 xl:pt-[56px]">
          <div className="relative z-10 flex max-w-lg flex-col items-center text-center md:max-w-xl md:items-start md:text-left xl:max-w-2xl">
            ...
            <h1 className="mt-8 font-display text-6xl leading-tight tracking-tight text-white sm:text-7xl md:mt-12 md:text-8xl">
            ...
            <p className="mt-9 max-w-xs font-display text-base leading-[1.32] tracking-[-0.025em] text-white/88 sm:max-w-sm sm:text-lg md:mt-11 md:max-w-md md:text-base xl:mt-14 xl:max-w-lg xl:text-2xl xl:leading-[1.34]">
            ...
            <div className="mt-10 flex w-full max-w-xs flex-col gap-4 md:mt-12 md:max-w-none md:flex-row xl:mt-16">
              <button
                type="button"
          ...
          <div className="pointer-events-none absolute bottom-0 right-[-34%] w-[88%] sm:right-[-24%] sm:w-[72%] md:right-[-12%] md:w-[52%] xl:right-[-2%] xl:top-[22px] xl:bottom-auto xl:w-[50%]">
            <Image
